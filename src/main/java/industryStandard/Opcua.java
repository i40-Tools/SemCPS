...
//
// public Opcua(RDFNode subject, RDFNode object, RDFNode predicate, Model model,
// LinkedHashSet<String> forAttribute,
// LinkedHashSet<String> forID, LinkedHashSet<String> forRefSemantic,
// Set<String> UAObject,
// LinkedHashSet<String> UAObjectType, LinkedHashSet<String> foreClassVersion,
// LinkedHashSet<String> foreClassIRDI, LinkedHashSet<String>
...
// if (parentNode != null) {
// setValues();
// addParentSubject(allSubjects, UAObject, ":" +
// subject.asNode().getLocalName());
// }
//
...
// {
// addOPCUAGeneric(allSubjects, foreClassClassificationClass,
...
// }
//
// private void addOPCUAGeneric(ArrayList<Resource> allSubjects,
// LinkedHashSet<String> generic, String name) {
...
// // attribute
// addParentSubject(allSubjects, forAttribute, ":" +
// subject.asNode().getLocalName());
//
// // specific case goes into attributes
// if (name == "eClassClassificationClass" || name == "eClassIRDI" || name ==
// "eClassVersion") {
//
// addSubjectURI(genericSubject, forAttribute, ":" +
// generictValue.asResource().getLocalName());
...
// StmtIterator stmts = model.listStatements(rdfSubject.asResource(), null,
// (RDFNode) null);
// while (stmts.hasNext()) {
...
// */
// boolean checkIfId() {
// StmtIterator stmts = model.listStatements(genericSubject.asResource(), null,
// (RDFNode) null);
// while (stmts.hasNext()) {
// Statement stmte = stmts.nextStatement();
...
// * @param forID
// */
// void addParentSubject(ArrayList<Resource> allSubjects, Set<String>
// forResource, String value) {
// for (int i = 0; i < allSubjects.size(); i++) {
// StmtIterator stmts = model.listStatements(allSubjects.get(i), null, (RDFNode)
// null);
// while (stmts.hasNext()) {
// Statement stmte = stmts.nextStatement();
//
